...
player_image = pygame.image.load("assets_exemplo/player.png")
player_image = pygame.transform.scale(player_image, (60, 60))
ground_image = pygame.image.load("assets_exemplo/ground.png")
ground_image = pygame.transform.scale(ground_image, (2600, 190))
obstacle_image = pygame.image.load("assets_exemplo/obstacle.png")
obstacle_image = pygame.transform.scale(obstacle_image, (40, 60))
tsunami_image = pygame.image.load("assets_exemplo/  tsunami.png")
