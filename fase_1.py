...
player_image = pygame.image.load("sprites_jogo/player.png").convert()
...
tsunami_image = pygame.image.load("sprites_jogo/tsunami.png")
tsunami_image = pygame.transform.scale(tsunami_image, (2200, 300))
background = pygame.image.load("sprites_jogo/fundo_1.png").convert()
background = pygame.transform.scale(background, (3200, 430))

pygame.mixer.init()
pygame.mixer.music.load("/Users/rafael/Downloads/musica.mp3")
...
def save_score(name, score):
    with open("scores1.txt", "a") as file:
